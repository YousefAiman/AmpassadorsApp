...
public class UsersPost extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    EditText post_text;
    Button posting;
    Button poll;
    Button image_btn;
    ...
    public void setUpComponte() {
        ...
        postImage = findViewById(R.id.image_user_posting_in_create_post);
    ...
    public void clickListiners() {
                ...
                if(!postTexting.isEmpty() && !downloadUrl.isEmpty()){
                    ...
                    reference.document(postId).set(dataMap)
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(UsersPost.this, "Failed to post!" +
                    ...
                    Toast.makeText(UsersPost.this, "Please Fill in the post form!"
        ...
        image_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Files.startImageFetchIntent(UsersPost.this);
            }
        });
        pdf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(UsersPost.this, "PDF", Toast.LENGTH_SHORT).show();
        ...
        video_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(UsersPost.this, "Video", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            storageReference.putFile(data.getData()).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UsersPost.this, e.getMessage(), Toast.LENGTH_SHORT).show();
