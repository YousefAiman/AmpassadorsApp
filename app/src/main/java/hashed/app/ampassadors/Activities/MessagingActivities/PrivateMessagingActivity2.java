...
public class PrivateMessagingActivity2 extends MessagingActivity{
  ...
  void showMessageOptionsBottomSheet() {
    ...
    parentView.findViewById(R.id.imageIv).setOnClickListener(view -> {
      ...
      Files.startImageFetchIntent(PrivateMessagingActivity2.this);
    });
    ...
    parentView.findViewById(R.id.videoIv).setOnClickListener(view -> {
      ...
      bsd.dismiss();
      Files.startVideoFetchIntent(PrivateMessagingActivity2.this);
    });
    ...
    parentView.findViewById(R.id.documentIv).setOnClickListener(view -> {
      ...
      bsd.dismiss();
      Files.startDocumentFetchIntent(PrivateMessagingActivity2.this);
    });
  ...
  void sendMessage(PrivateMessage privateMessage) {
    ...
    childRef.setValue(privateMessage)
      ...
      Toast.makeText(PrivateMessagingActivity2.this, R.string.message_send_failed,
